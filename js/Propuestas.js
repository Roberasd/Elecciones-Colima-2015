...
Propuesta("Escuelas de tiempo completo", 'Impulsar las escuelas de tiempo completo, así como una educación cívica en el estado.', temas.EDUCACION, 4, 0),
Propuesta("Autonomía a la Comision de Derechos Humanos", 'Brindarle una verdadera autonomía a la Comisión de Derechos Humanos del Estado de Colima (CDHEC).', temas.INSTITUCIONAL, 4, 0),
...
Propuesta("Cadenas productivas en el campo", 'Generar cadenas productivas en el campo para que los campesinos exporten sus productos a todos los continentes.', temas.ECONOMIA, 5, 0),
Propuesta("Género y diversidad sexual", 'Legislar en materia de perspectiva de género y diversidad sexual.', temas.DERECHOS_HUMANOS, 5, 0),
Propuesta("No mas cortes de agua", 'Se dejará de cortar el agua en las viviendas, actos ilegales que realiza el Ayuntamiento actual. Se les den facilidades para que la gente pague sus impuestos en la medida de sus posibilidades, y posteriormente el gobierno refleje los impuestos en beneficios para la gente.', temas.PLANEAMIENTO_URBANO, 5, 0),
...
Propuesta("Fomentar el desarrollo inicial", 'Fomentar el desarrollo desde los ninos de 45 días de nacidos hasta los 6 años en el nivel inicial, utilizando el modelo de los CENDIs Tierra y Libertad.', temas.EDUCACION, 3, 0),
Propuesta("Modelo integral superior y medio superior", 'En el nivel medio superior y superior fomentar un modelo integral en el cual se se desarrollará mejores personas, mejores seres humanos que logren incidir para tener un mejor estado.', temas.EDUCACION, 3, 0),  
Propuesta("Comité ciudadano para la educación", 'Creación de un comité conformado por ciudadanos, profesores y gobierno que desarrolle un sistema para conocer los avances en el sector educativo y cómo poder mejora ese avance educativo que tanto se quiere para el estado.', temas.EDUCACION, 3, 0)
/*Propuesta("", '', temas.EDUCACION, 3,0),  */
];
}
