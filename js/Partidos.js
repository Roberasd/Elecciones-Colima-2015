...
{
partidos = [
	Partido(0, 'PRI', 'pri.jpg', '#01DF01'),
	Partido(1, 'PAN', 'pan.jpg', '#2E64FE'),
	Partido(2, 'PRD', 'prd.jpg', '#FFBF00'),
	Partido(3, 'PT', 'pt.png', '#FF0000'),
	Partido(4, 'MORENA', 'morena.jpg', '#DF3A01'),
	Partido(5, 'Partido Humanista', 'ph.jpg', '#B404AE'),
	Partido(6, 'PES', 'pes.png', '#8000FF'),
	Partido(7, 'Movimiento Ciudadano', 'mc.jpg', '#DF7401')
];
}
/*
function CargarPartidos()
...
partidos = [
	...
	Partido(5, 'Mov. para el Bien Comun', 'bc.png', '#198BA5'),
	...
	Partido(15, 'Autodet. y Libertad', 'ayl.png', '#790786')
];
}*/